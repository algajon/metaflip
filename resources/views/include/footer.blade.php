...
<div class="border-2 drop-shadow-3xl border-gray-400 shadow-4xl w-full"></div>
<footer class="bg-gray-900 font-onest" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8 lg:py-8">
    ...
    <div class="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
      ...
      <form class="mt-4 sm:flex sm:max-w-md lg:mt-0">
        ...
        <input type="email" name="email-address" id="email-address" autocomplete="email" required class="w-full min-w-0 appearance-none rounded-md border border-transparent bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 focus:border-white focus:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 sm:max-w-xs" placeholder="Enter your email">
        <div class="mt-3 rounded-md sm:ml-3 sm:mt-0 sm:flex-shrink-0">
          <button type="submit" class="bg-yellow-300 card text-black text-center font-bold px-3 py-1 shadow-xl rounded-2xl inline-block">Subscribe</button>
        </div>
      </form>
    </div>
    <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">&copy; 2023 Metaflip, Inc. All rights reserved.</p>
    </div>
  </div>
</footer>