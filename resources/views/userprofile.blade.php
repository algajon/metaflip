...
<header class="relative bg-gray-200 isolate font-onest pt-16">
    ...
    <div class="mx-auto max-w-7xl mt-6 px-4 py-10 sm:px-6 lg:px-8">
      <div class="mx-auto flex max-w-2xl items-center justify-between gap-x-8 lg:mx-0 lg:max-w-none">
        <div class="flex items-center gap-x-6">
        @if(auth()->user()->profile_picture)
            <img src="{{ asset('profile_pictures/' . auth()->user()->profile_picture) }}" alt="Profile Picture">
            @else
            <img src="./images/joni.jpg" class="h-16 w-16 ring-2 ring-black mt-1 mr-2 rounded-full"></a>
            @endif          
            <h1>
            <div class="mt-1 text-2xl font-bold leading-6 text-gray-900">{{ Auth::user()->name }}</div>
          </h1>
        </div>
        <div class="flex items-center gap-x-4 sm:gap-x-6">
          ...
          <a href="#" class="rounded-md bg-yellow-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-400">Send</a>
        ...
        <div class="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5">
          <dl class="flex flex-wrap">
            ...
            <div class="flex-none self-end px-6 pt-4">
              ...
              <dd class="rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-400 ring-1 ring-inset ring-green-400/20">Paid</dd>
            </div>
      ...
      <div class="lg:col-start-3">
        ...
        <div class="mt-6 flex gap-x-3">
          ...
          <form action="#" class="relative flex-auto">
            <div class="overflow-hidden rounded-lg pb-12 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-yellow-400">
